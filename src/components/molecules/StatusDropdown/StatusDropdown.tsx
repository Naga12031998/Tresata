...
interface StatusDropdownProps {
  ...
  onChange: (value: "In Progress" | "Pending" | "Completed") => void;
}
...
export const StatusDropdown: React.FC<StatusDropdownProps> = ({
  ...
  const options: Array<"Pending" | "In Progress" | "Completed"> = [
    "Pending",
    "In Progress",
    "Completed",
  ];
  ...
  return (
    ...
    >
      <div className="dropdown-selected" onClick={() => setIsOpen(!isOpen)}>
        <div className={`status-indicator ${getStatusClass(value)}`}></div>
